...
namespace Helpers
{
    ...
    public static class ResourceCountHelper
    {
        ...
        public static ShortenedValue CountShortener(long amount)
        {
            return amount switch
            {
                > 1000000000 => new ShortenedValue((float) (amount / 1000000000.0), "{0:1}B"),
                > 1000000 => new ShortenedValue((float) (amount / 1000000.0), "{0:1}M"),
                > 10000 => new ShortenedValue((float) (amount / 1000.0), "{0:1}K"),
                _ => new ShortenedValue(amount, "{0:0}")
            };
        } 
    }
}
